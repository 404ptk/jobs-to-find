...
<div class="min-h-[calc(100vh-8rem)] py-12 px-4">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-green-500">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm text-gray-500 font-medium uppercase tracking-wider">Active Offers</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $activeOffers }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-yellow-500">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm text-gray-500 font-medium uppercase tracking-wider">Pending</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $pendingOffers }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
            <form action="{{ route('admin.offers') }}" method="GET" class="flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                ...
                @if(request('search'))
                    <a href="{{ route('admin.offers') }}" class="px-6 py-2 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 transition text-center">
                        Clear
                    </a>
                @endif
            </form>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Job Offer</th>
                        ...
                        @forelse($offers as $offer)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $offer->user->first_name }} {{ $offer->user->last_name }}</div>
