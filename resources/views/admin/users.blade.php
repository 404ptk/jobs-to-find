...
<div class="min-h-[calc(100vh-8rem)] py-12 px-4">
    <div class="max-w-7xl mx-auto">
        ...
        <x-table :headers="['User', 'Role', 'Country', 'Joined']" :pagination="$users">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">
                                    <button onclick="openUserModal({{ $user->id }})" class="hover:text-blue-600 hover:underline cursor-pointer text-left">
...
<div id="user-profile-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto transform transition-all scale-95 opacity-0 relative" id="user-modal-content">
        <button onclick="hideUserModal()" class="absolute top-4 right-4 text-white hover:text-gray-200 z-20 cursor-pointer bg-black bg-opacity-30 rounded-full p-1 hover:bg-opacity-50 transition">
