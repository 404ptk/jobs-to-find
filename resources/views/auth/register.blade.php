    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="bg-white rounded-lg shadow-xl p-8">
            <form method="POST" action="/register" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <button 
                            ...
                            class="cursor-pointer account-type-btn px-4 py-3 border-2 border-blue-600 bg-blue-600 text-white rounded-lg font-medium transition hover:bg-blue-700 hover:border-blue-700"
                        >
                            Looking for a job
                        </button>
                        <button 
                            ...
                            class="cursor-pointer account-type-btn px-4 py-3 border-2 border-gray-300 bg-white text-gray-700 rounded-lg font-medium transition hover:border-gray-400"
                        >
                            I'm an employer
                        </button>
                    </div>
                ...
                <button 
                    type="submit"
                    class="cursor-pointer w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition shadow-md hover:shadow-lg"
                >
                    Create account
                </button>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button 
                        type="button"
                        class="cursor-pointer flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition"
                    >
