                    ...
                    <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition border border-gray-200 hover:bg-gray-100">
                        <div class="p-6">
                            ...
                            <div class="flex gap-3">
                                @guest
                                    <a href="/login" class="px-3 py-2 rounded-lg text-gray-400 hover:text-red-500 hover:bg-red-50 transition" title="Login to save to favorites">
                                ...
                                @auth
                                    @if(Auth::user()->account_type === 'job_seeker')
                                        <button class="px-3 py-2 rounded-lg text-gray-400 hover:text-red-500 hover:bg-red-50 transition cursor-pointer" title="Save to favorites">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                                            </svg>
                                        </button>
