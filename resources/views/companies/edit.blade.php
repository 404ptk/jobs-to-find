            ...
            <div class="col-span-2 md:col-span-1">
              ...
              <select id="country" name="country" required
                ...
                @foreach($countries as $country)
                  <option value="{{ $country }}" {{ old('country', $company->location ? $company->location->country : '') == $country ? 'selected' : '' }}>
                    {{ $country }}
                  </option>
                @endforeach
              </select>
            ...
            <div class="col-span-2 md:col-span-1">
              ...
              <select id="location_id" name="location_id" required
                ...
                @foreach($locations as $location)
                  <option value="{{ $location->id }}" data-country="{{ $location->country }}" {{ old('location_id', $company->location_id) == $location->id ? 'selected' : '' }}>
                    {{ $location->city }}
                  </option>
                @endforeach
              </select>
