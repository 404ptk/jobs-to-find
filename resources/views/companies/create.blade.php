...
@section('title', 'Register Company - Jobs to Find')
  ...
  <div class="min-h-[calc(100vh-8rem)] py-12 px-4">
    <div class="max-w-3xl mx-auto">
      <div class="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 class="text-3xl font-bold text-gray-900">Register New Company</h1>
          <p class="text-gray-600">Provide details about the company you'll be hiring for</p>
        </div>
      </div>
        ...
        <div class="p-8">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="col-span-2 md:col-span-1">
              ...
              <input type="number" name="founded_at" id="founded_at" value="{{ old('founded_at') }}" min="1900"
                max="{{ date('Y') + 1 }}"
                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
            ...
            <div class="col-span-2 md:col-span-1">
              ...
              <input type="file" name="logo" id="logo" accept="image/*"
                class="w-full px-4 py-2 rounded-lg border border-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition">
              <p class="mt-1 text-xs text-gray-500">Max size 2MB (JPG, PNG)</p>
            ...
            <div class="col-span-2">
              ...
              <textarea name="description" id="description" rows="5" required
                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                placeholder="Describe what your company does...">{{ old('description') }}</textarea>
